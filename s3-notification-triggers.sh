...
####
# Author: Manuchimso Oliver
# Version: 1.0.0
# Date: 20/05/2023
# Purpose: This script creates an S3 Bucket in AWS, configures an IAM role and sets up notifications using SNS to notify a user via email whenever a new item is uploaded to the S3 bucket
####
